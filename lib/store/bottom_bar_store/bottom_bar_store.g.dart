...
mixin _$BottomBarStore on BottomBarBase, Store {
  final _$selectedIndexAtom = Atom(name: 'BottomBarBase.selectedIndex');
  ...
  final _$BottomBarBaseActionController =
      ActionController(name: 'BottomBarBase');

  @override
  void onItemTapped(int index) {
    final _$actionInfo = _$BottomBarBaseActionController.startAction(
        name: 'BottomBarBase.onItemTapped');
    try {
